...
# Load the data from the script directory
script_dir = os.path.dirname(os.path.abspath(__file__))
filepath = os.path.join(script_dir, 'SMSSpamCollection.csv')
...
X_train = X_train.str.replace(r'\W', ' ', regex=True)
...
#Remove all punctuation marks
X_test = X_test.str.replace(r'\W', ' ', regex=True)
#Change all letters to small case
